...
First we get the solar reference spectrum:
 ...
 ```{r esun1, fig.height = 5, fig.path="../assets/knitFigs/",fig.width = 6, echo = TRUE, message = FALSE, error = FALSE}
library(xlsx)
library(ggplot2)
library(reshape2)
...
```{r esun2, fig.height = 3, fig.path="../assets/knitFigs/", echo = TRUE, message = FALSE, error = FALSE}
