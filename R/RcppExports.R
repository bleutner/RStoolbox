...
spectralIndicesCpp <- function(x, indices, redBand, blueBand, greenBand, nirBand, swir1Band, swir2Band, swir3Band, L, s, G, C1, C2, Levi, swir2ccc, swir2cdiff, sf) {
    .Call('RStoolbox_spectralIndicesCpp', PACKAGE = 'RStoolbox', x, indices, redBand, blueBand, greenBand, nirBand, swir1Band, swir2Band, swir3Band, L, s, G, C1, C2, Levi, swir2ccc, swir2cdiff, sf)
}
